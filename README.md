...
To install just save [arc-dark.edj](https://github.com/okratitan/enlightenment-arc-theme/arc-dark.edj) and/or [arc.edj](https://github.com/okratitan/enlightenment-arc-theme/arc.edj) to the themes directory `$HOME/.elementary/themes/` or `make install`.
